...
function applyWinningPattern(a, b, c) {
    document.getElementById(a).style.background = "#67db17";
    document.getElementById(b).style.background = "#67db17";
    document.getElementById(c).style.background = "#67db17";
}
...
function reset() {
for (var i = 0; i < state.length; i++) {
        document.getElementById(i).style.backgroundColor = "#b108a6";
...
document.getElementById('start').addEventListener('click', function (e) {
    e.preventDefault();
    if (player1_tag.value == "" || player2_tag.value == "") {
        // var choice = confirm("Please enter the names of 1st and 2nd player"); 
        alert("Please enter the names of 1st and 2nd player")
        // document.getElementById("player-1").required="true";
        // document.getElementById("player-2").required="true";
